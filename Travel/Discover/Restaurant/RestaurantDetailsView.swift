...
//  Travel
//
//  Created by Roman Vol on 29.11.2020.
//
...
struct PopularDish: Decodable, Hashable {
    ...
    var body: some View {
        ScrollView {
            ...
            ZStack (alignment: .bottomLeading) {
                ...
                LinearGradient(gradient: Gradient(colors: [Color(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)), Color.clear]), startPoint: .bottom, endPoint: .center)
                     .ignoresSafeArea()
...
struct RestaurantDetailsView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            RestaurantDetailsView(restaurant: .init(name: "Japan's Finest Tapas", imageName: "burger"))
        }
